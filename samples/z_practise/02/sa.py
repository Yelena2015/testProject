...
desired_caps['platformVersion'] = '6.0'  # todo
desired_caps['deviceName'] = 'test'
desired_caps['app'] = r'e:\apk\duoduoCalculators.apk'
desired_caps['appPackage'] = 'com.ibox.calculators' # todo
desired_caps['appActivity'] = 'com.ibox.calculators.SplashActivity'    # todo
